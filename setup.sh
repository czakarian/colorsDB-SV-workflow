...
#curl -o ${JASMINECMD} https://depot.galaxyproject.org/singularity/jasminesv%3A1.1.5--hdfd78af_0 -C -
curl -o ${BCFTOOLSCMD} https://depot.galaxyproject.org/singularity/bcftools%3A1.19--h8b25389_1 -C -
curl -o ${TRUVARICMD} https://depot.galaxyproject.org/singularity/truvari%3A5.2.0--pyhdfd78af_0 -C -
...
echo $(date) - Formatting ColorsDB vcf by adding filling IDs and addding SAMPLE column.
