...
${BCFTOOLSCMD} bcftools index --threads ${THREADS} --tbi ${OUTDIR}/debug/${PREFIX}.colorAnno.vcf.gz
...
${BCFTOOLSCMD} bcftools index --threads ${THREADS} --tbi ${OUTDIR}/debug/${PREFIX}.colorAnno.1000gAnno.vcf.gz 
...
${BCFTOOLSCMD} bcftools index --threads ${THREADS} --tbi ${OUTDIR}/debug/${PREFIX}.oversizedSVs.vcf.gz
...
${BCFTOOLSCMD} bcftools index --threads ${THREADS} --tbi ${OUTDIR}/debug/${PREFIX}.colorAnno.1000gAnno.withColorsOversized.vcf.gz
...
${BCFTOOLSCMD} bcftools index --threads ${THREADS} --tbi ${OUTDIR}/debug/${PREFIX}.colorAnno.1000gAnno.withColorsOversized.with1000gOversized.vcf.gz
...
${BCFTOOLSCMD} bcftools index --threads ${THREADS} --tbi ${OUTDIR}/debug/${PREFIX}.colorAnno.1000gAnno.combined.vcf.gz
...
${BCFTOOLSCMD} bcftools index --threads ${THREADS} --tbi ${OUTDIR}/${PREFIX}.colorAnno.1000gAnno.final.vcf.gz
